...
public class WordLengthFinder {
    public static void main(String[] args) {
        ...
        System.out.println("\nShortest word: " + wordsWithLengths[shortestLongest[0]][0] + " (Length: " + wordsWithLengths[shortestLongest[0]][1] + ")");
        System.out.println("Longest word: " + wordsWithLengths[shortestLongest[1]][0] + " (Length: " + wordsWithLengths[shortestLongest[1]][1] + ")");
    }
    ...
    public static int[] findShortestLongest(String[][] wordsWithLengths) {
        ...
        for (int i = 1; i < wordsWithLengths.length; i++) {
            ...
            if (length < Integer.parseInt(wordsWithLengths[shortestIndex][1])) {
                shortestIndex = i;
            }
            if (length > Integer.parseInt(wordsWithLengths[longestIndex][1])) {
                longestIndex = i;
            }
        }
